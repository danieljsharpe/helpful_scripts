MODULE COMMONS
     ...
     &        RFKMCN, RFKMCSTEPS, NPEQ, MLPSTART, MLPIN, MLPOUT, MLPHIDDEN, NMLP, NOPT, CVSTARTMIN, CVENDMIN, CVINCMIN, &
     &        MAXCANDIDATES, CONNECTMIN2F, CONNECTMIN2SAVE, NZEROS, MLPNEIGH, SHANNON_NEXCLUDE, REFMINID
      ...
      INTEGER, ALLOCATABLE :: SHANNON_EXCLUDELIST(:)
!
! I/O unit numbers
!
...
! NRWBINS
     ...
     &                 PERTHRESH, SHANNONTMIN, SHANNONTMAX, SHANNONTINC, RATEAB, RATEBA, MINBARRIER, DISBOUND, MIN_EDIFF
...
! NATOMS
      ...
      INTEGER NFSTART, NFFINISH, NINTS, NCONNMIN, CONNECTMIN1, CONNECTMIN2, NFREEZE, NPATHS, KPATHS, &
     &        RLEDGE_DEFN, PARALLEL, NRANDOMMETRIC, &
     &        METRICUPAIR, METMATMAX, NPRUNE, NADDPATH, DLvars

      LOGICAL YESNO, TEST1, TEST2, DEBUG, PRINTT, ADDPT, ADDPT2, ADDPT3, TWOD, BULKT, ANGLEAXIS, TAGT, &
     &        CHARMMT, AMBERT, OPEPT, NEWREAXFFT, STARTFROMPATH, RELATIVEET, EXTRACTTSFILET, &
     ...
     &        NIH2LEPST, DISTANCET, DISTANCETST, RATETARGETT, TARGETHIT, ALLOWABT, MICROTHERMT, RFKMCT, REGROUPKMCT, ONEREGROUPT, &
     &        PHI4MODT, PERSISTT, REGROUPPERSISTT, NOLABELST, SHANNONT, MAKEPAIRS, SKIPPAIRST, PERSISTAPPROXT, ALLCOMPONENTST, &
     &        SHANNONRT, SHANNONZT, CUDAT, MLLJAT3, MLP3T, DIJPRUNET, PRINTSUMMARYT, MKTRAPT, MLPB3T, PRUNECYCLET, PAIRSIGNORET, &
     &        NOTRANSROTT, NOPOINTGROUPT, MACROIONT, CONNECTPAIRST, INITIALDIST, MLPVB3NNT, OVERWRITE_INERTIA, SHANNON_EXCLUDET, &
     &        USEEXEC, ANCHORT, WILKEST, DLT, DOINVERSION, KDISTINCTPATHST, KDPDUMPEDGEST, KDPMDFCUMT, DUMPINFOMAPT, INFOMAPT
      ...
      CHARACTER(LEN=80) ADDPATHNAME(1000)
      CHARACTER(LEN=250) COPYFILES
